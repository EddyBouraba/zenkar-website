...
export default function Hero() {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 flex flex-col sm:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col items-start sm:items-end gap-3 flex-shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-8 py-3.5 rounded font-heading font-bold text-sm text-bg tracking-widest uppercase transition-all duration-200 hover:-translate-y-0.5 active:scale-95"
              style={{
      ...
      {showModal && <HowToJoinModal onClose={() => setShowModal(false)} />}
    </>
  )
}
